    ...
    */
    ...
    'connections' => [
        ...
        'mysql' => [
            ...
            'username' => is_file('/vault/secrets/db-username') ? trim(file_get_contents('/vault/secrets/db-username')) : env('DB_USERNAME', 'forge'),
            'password' => is_file('/vault/secrets/db-password') ? trim(file_get_contents('/vault/secrets/db-password')) : env('DB_PASSWORD', ''),
